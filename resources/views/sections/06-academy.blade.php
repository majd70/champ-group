        ...
        <div class="flex flex-col gap-10">
            ...
            <div class="flex items-end gap-6 md:gap-10">
                ...
                <div class="flex flex-col gap-3">
                    <span class="text-[clamp(64px,10vw,160px)] leading-[0.9] tabular-nums text-[var(--color-accent-gold)]" style="font-family: var(--font-display);">8,000</span>
            ...
            <div class="grid grid-cols-3 gap-x-6 gap-y-8 md:gap-x-8 md:gap-y-10">
                @foreach ($stats as $i => $stat)
                    <div class="flex flex-col gap-2 {{ $i >= 3 ? 'md:border-t md:border-[var(--color-divider)] md:pt-8' : '' }}">
                        <span class="text-[clamp(36px,4.5vw,72px)] leading-none tabular-nums text-[var(--color-accent-gold)]" style="font-family: var(--font-display);">{{ $stat['number'] }}</span>
